...
| autovacuum_vacuum_max_threshold | 100000000 | default |
...
| commit_timestamp_buffers | 32 8kB | default |
| compute_query_id | auto | default |
| config_file | /var/lib/postgresql/18/docker/postgresql.conf | override |
...
| data_directory | /var/lib/postgresql/18/docker | override |
...
| effective_io_concurrency | 16 | default |
| enable_async_append | on | default |
| enable_bitmapscan | on | default |
| enable_distinct_reordering | on | default |
| enable_gathermerge | on | default |
| enable_group_by_reordering | on | default |
...
| enable_self_join_elimination | on | default |
...
| event_triggers | on | default |
| exit_on_error | off | default |
| extension_control_path | $system | default |
| external_pid_file |  | default |
| extra_float_digits | 1 | default |
| file_copy_method | copy | default |
...
| hba_file | /var/lib/postgresql/18/docker/pg_hba.conf | override |
| hot_standby | on | default |
| hot_standby_feedback | off | default |
| huge_pages | try | default |
| huge_page_size | 0 kB | default |
| huge_pages_status | off | default |
| icu_validation_level | warning | default |
| ident_file | /var/lib/postgresql/18/docker/pg_ident.conf | override |
| idle_in_transaction_session_timeout | 0 ms | default |
| idle_replication_slot_timeout | 0 s | default |
...
| io_combine_limit | 16 8kB | default |
| io_max_combine_limit | 16 8kB | default |
| io_max_concurrency | 64 | default |
...
| maintenance_io_concurrency | 16 | default |
| maintenance_work_mem | 65536 kB | default |
| max_active_replication_origins | 10 | default |
...
| max_notify_queue_pages | 1048576 | default |
...
| md5_password_warnings | on | default |
...
| multixact_member_buffers | 32 8kB | default |
| multixact_offset_buffers | 16 8kB | default |
| notify_buffers | 16 8kB | default |
| num_os_semaphores | 174 | default |
| oauth_validator_libraries |  | default |
...
| serializable_buffers | 32 8kB | default |
| server_encoding | UTF8 | default |
| server_version | 18.3 (Debian 18.3-1.pgdg13+1) | default |
| server_version_num | 180003 | default |
| session_preload_libraries |  | default |
| session_replication_role | origin | default |
| shared_buffers | 16384 8kB | configuration file |
| shared_memory_size | 150 MB | default |
| shared_memory_size_in_huge_pages | 75 | default |
...
| ssl_groups | X25519:prime256v1 | default |
...
| trace_connection_negotiation | off | default |
...
| vacuum_buffer_usage_limit | 2048 kB | default |
...
| vacuum_max_eager_freeze_failure_rate | 0.03 | default |
...
| wal_summary_keep_time | 14400 min | default |
...
CREATE TABLE public.data_types_test (
    ...
    CONSTRAINT data_types_test_id_not_null NOT NULL id,
...
CREATE TABLE public.logs (
    ...
    message text,
    level varchar(20),
    CONSTRAINT logs_id_not_null NOT NULL id,
    CONSTRAINT logs_log_date_not_null NOT NULL log_date
);
```
...
CREATE TABLE public.order_items (
    ...
    CONSTRAINT order_items_order_id_not_null NOT NULL order_id,
    CONSTRAINT order_items_product_id_not_null NOT NULL product_id,
    CONSTRAINT order_items_quantity_not_null NOT NULL quantity,
    CONSTRAINT order_items_unit_price_not_null NOT NULL unit_price,
...
CREATE TABLE public.orders (
    ...
    CONSTRAINT orders_total_amount_not_null NOT NULL total_amount,
    CONSTRAINT orders_user_id_not_null NOT NULL user_id,
...
CREATE TABLE public.products (
    ...
    CONSTRAINT products_price_not_null NOT NULL price,
    CONSTRAINT products_stock_quantity_not_null NOT NULL stock_quantity,
